...
var eleWm = document.getElementById("wm"),
  ...
  eleLeftWm = eleWm.offsetLeft;
  eleTopWm = eleWm.offsetTop;

var marginWm = {top: 20, right: 20, bottom: 30, left: 40},
    widthWm = eleWidthWm - marginWm.left - marginWm.right,
    heightWm = eleWidthWm/2 - marginWm.top - marginWm.bottom;
...
/*const projectionWm = d3.geoRobinson()
    ...
    var projectionWm = d3.geoMercator().scale(widthWm / 2 / Math.PI)
    .translate([widthWm / 2, heightWm / 2]);
